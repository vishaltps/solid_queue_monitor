...
ActiveRecord::Schema[7.0].define(version: 20_230_101_000_001) do
  ...
  create_table 'solid_queue_jobs', force: :cascade do |t|
    ...
    t.index %w[queue_name finished_at], name: 'index_solid_queue_jobs_on_queue_name_and_finished_at'
  end
  ...
  create_table 'solid_queue_scheduled_executions', force: :cascade do |t|
    ...
    t.index %w[scheduled_at queue_name priority job_id], name: 'index_solid_queue_dispatch_by_queue'
  end
